...
void solve()
{
    ...
    int oddFirst = 0, evenFirst = 0;
    for (int i = 0; i < n; i++)
    {
        if ((i % 2 && a[i] % 2) || (i%2==0 && a[i]%2 == 0))
        {
            evenFirst++;
        }
        else if ((i % 2 == 0 && a[i] % 2) || (i%2 == 1 && a[i]%2 == 0))
        {
            oddFirst++;
        }
        if (a[i] % 2)
    ...
    else if (evenFirst > oddFirst)
    {
        cout << n - evenFirst << endl;
        int firstOdd = -1;
        int firstEven = -1;
        for (int i = 0; i < n; i++)
        {
